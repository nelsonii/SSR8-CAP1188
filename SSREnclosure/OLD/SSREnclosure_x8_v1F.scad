...
*/ 
    ...
    color("hotpink")
     translate([-(relayBoardMountX/2), -(relayBoardMountY/2)+standoffSize+wallThickness-mcuBoardY, 1])
      cube([mcuBoardX/2, mcuBoardY, outputZ]);
     
    //Aux USB Micro board mount
    color("lime")
     translate([-16,  -(relayBoardMountY/2)+standoffSize+wallThickness-mcuBoardY, 1])
      cube([13, 13, outputZ]);
  ...
  color("coral")
     translate([-13.5, -(relayBoardMountY/2)+wallThickness-mcuBoardY, outputZ+2])
  ...
  color("orangered")
   translate([-13.75, -(caseDepthY/2)+10, (wallThickness/2)])
    cylinder(h=outputZ, d=mountingScrewDiameter);
  color("orangered")
   translate([-5.25, -(caseDepthY/2)+10, (wallThickness/2)])
    cylinder(h=outputZ, d=mountingScrewDiameter);    
